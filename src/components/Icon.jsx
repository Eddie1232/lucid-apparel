const paths = {
  home: <path d="M3 10.5 12 3l9 7.5M5 9.5V20a1 1 0 0 0 1 1h3v-6h6v6h3a1 1 0 0 0 1-1V9.5" />,
  bag: (
    <>
  ...
  cart: (
    <>
      ...
      <path d="M3 4h2l2.2 11.2a1 1 0 0 0 1 .8h8.5a1 1 0 0 0 1-.8L20 7H6" />
    </>
  ),
  heart: <path d="M12 20s-7-4.4-9.2-8.6C1.3 8.1 2.6 5 5.6 5c2 0 3.2 1.4 3.9 2.4C10.2 6.4 11.4 5 13.4 5c3 0 4.3 3.1 2.8 6.4C18 15.6 12 20 12 20Z" />,
  user: (
    <>
  ...
  star: <path d="m12 3 2.6 5.6 6.1.7-4.5 4.1 1.2 6L12 16.9 6.6 19.4l1.2-6-4.5-4.1 6.1-.7L12 3Z" />,
  help: (
    <>
      <circle cx="12" cy="12" r="9" />
...
const filled = new Set(["star", "heartFill"]);

export default function Icon({ name, size = 22, fill = false, stroke = 1.7, className, style }) {
  const isStar = name === "star" && fill;
  return (
    <svg
      className={className}
      style={style}
